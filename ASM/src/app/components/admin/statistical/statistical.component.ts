...
@Component({
  ...
  standalone: true,
  imports: [AdminLeftComponent, CommonModule],
...
export class StatisticalComponent {
  ...
  // Function to calculate the total number of unique individuals (customers)
  ...
  // Function to calculate the total revenue from all products
